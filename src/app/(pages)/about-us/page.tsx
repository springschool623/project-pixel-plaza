...
export default function AboutUs() {
    return(
        <div>
            <div className={styles.aboutUsContainer}>
                ...
                <div>
                    <div className={styles.headerContainer}>
                        <h1 className={`${vt323.className} ${styles.aboutUsTitle}`}>
                            CHÚNG TÔI LÀ?
                        </h1>
                        <span className={styles.aboutUsTitleDecor}>
                            <Image src="/subimgitem.png" width={30} height={25} alt="deco"/>
                        </span>
                    </div>
                    <h4>Cửa hàng Game - Phụ kiện Game - Thiên đường của game thủ</h4>
                    <p>
            ...
            <div className={styles.aboutUsContainer}>
                <div>
                    <h4>Bạn có thể tìm thấy những loại đồ chơi nào tại Hobiverse?</h4>
                    <p>
                ...
                <div>
                    <Image src="/pixel-7272046_1280.png" alt="Pixel Art" width={600} height={450} className={styles.imgBorder}/>
                </div>
            </div>
        </div>
    )
